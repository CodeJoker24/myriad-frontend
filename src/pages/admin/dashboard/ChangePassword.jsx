...
export const ChangePassword = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-6">
        <Link to="/admin/dashboard/profile" className="inline-flex items-center gap-2 text-gray-600 hover:text-primary mb-4">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
        ...
        <button
          ...
          disabled={loading}
          className="bg-primary hover:bg-primary-dark text-white px-10 py-4 rounded-xl font-bold transition-all shadow-lg disabled:opacity-50"
        >
